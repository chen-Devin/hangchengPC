    ...
    layui.use(['form', 'laydate', 'layer'], function() {
        ...
        $.get('/ucenter/general/finance/bankFlow/showOne.shtml?id='+$newId, function(d) {
                ...
                if ($code === 'SUCCESS') {
                    ...
                    var accountantOne = $objects.subjectIds[0];
                    var accountantTwo = $objects.subjectIds[1];
                    var accountantThree = $objects.subjectIds[2];
                    var accountantFour = $objects.subjectIds[3];
